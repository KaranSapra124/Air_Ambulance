  ...
  return (
    <>
      ...
      <GlobalServiceContent
        ...
        content={[
          "👉 The Air Ambulance is one of the fastest expanding in the world in the Subcontinent. Operating services on both national and international flights on an emergency and non-emergency basis.",
      ...
      <GlobalContentContainer
        ...
        content={[
          "The DHHR Rescue team is comprised of doctors, paramedics, people whose experience in the healthcare area provides a high level of service and assistance.",
      ...
      <GlobalServiceContent
        ...
        content={[
          ...
          "👉 Despite the patient’s condition and where it is supposed to be shifted,DHHR will do its utmost to move those patients to a safer location as soon as possible. Air Ambulance includes a hospital bed stretcher on board.",
        ]}
      />
      <GlobalContentContainer
